...
urlpatterns = [
    ...
    path("courses/<int:pk>/enroll/", views.EnrollCourseView.as_view(), name="course_enroll"),
    path("mpesa/stk-push/<int:pk>/", views.MpesaSTKPushView.as_view(), name="mpesa_stk_push"),
    path("webhook/mpesa/", views.MpesaCallbackView.as_view(), name="mpesa_webhook"),
